      ...
      <VStack w={"full"} justify={"center"} px={useBreakpointValue({ base: 4, md: 8 })} bgGradient={"linear(to-r, blackAlpha.600, transparent)"}>
        <Stack maxW={"2xl"} align={"flex-start"} spacing={6}>
          <Text color={"white"} fontWeight={350} lineHeight={1.2} fontSize={useBreakpointValue({ base: "2xl", md: "3xl" })}>
            PT. Digilab is a digital convergence company that creates value by integrating creative design and high class IT solutions. Today with the growth of technology and people's need for easy, fast, and complete services, we develop
            software and mobile application products for your daily needs.
          </Text>
          <Stack direction={"row"}>
            <Link href="about">
